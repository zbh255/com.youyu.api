...
func TestMysqlApiArticle(t *testing.T) {
	...
	rpcErr, err = client.DelArticle(context.Background(), &rpc.GetArticleRequest{ArticleId: article.GetArticleId()})
	if err != nil {
		t.Error(err.Error())
	} else {
...
func TestMysqlUserLoginAndSign(t *testing.T) {
	...
	errors, err := client.CreateUserSign(context.Background(),&rpc.UserLoginOrSign{
		UserName:     userName,
